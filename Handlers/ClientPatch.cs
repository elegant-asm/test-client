...
internal class ClientPatch {
    ...
    [HarmonyPatch(typeof(MasterClient), "drop")]
    [HarmonyPrefix]
    private static bool MC_drop() {
        Plugin.Log.LogWarning("MC_drop");
        return false;
    }
    ...
    //[HarmonyPatch(typeof(Client), "DoRead")]
    //[HarmonyPrefix]
    //private static bool DoRead() {
    //    Client.cs.send_spectator();
    //    Client.cs.recv_spectator();
    //    return true;
    //    //return !TestComponent.test;
    //}
